...
public class TutorialScreen6 {
    ...
    public TutorialScreen6(){
    }
	 public static ScreenManager TutorialScreen6;
     ...
     public static void run() {
     	TutorialScreen6 = new ScreenManager();;
         try {
             DisplayMode displayMode =
             TutorialScreen6.findFirstCompatibleMode(POSSIBLE_MODES);
             TutorialScreen6.setFullScreen(displayMode);
             TutorialScreen6.getFullScreenWindow();
             Window windowStart = TutorialScreen6.getFullScreenWindow();
             windowStart.addKeyListener(new KeyClass());
             loadImages();
             animationLoop();
         }
         finally {
        	 TutorialScreen6.restoreScreen();
         }
     }
     
	public static void loadImages() {
        //loads images into buffer
         bgImage = loadImage("images/6power6.jpg");
    ...
    public static void animationLoop() 
    {
    	while(setState == 0)
    	{
    		...
    		Graphics2D g = TutorialScreen6.getGraphics();
    		draw(g);
    		g.dispose();
    		TutorialScreen6.update();
    ...
    /*	else if(setState== 3){
    		...
    		TutorialScreen6.restoreScreen();                      // This will make the tutorial loop back to the previous screen. Currently flickers and does not stop.
    		ts5.run(); 
    	} */
    }
