...
public class TutorialScreen4 {
    ...
    public TutorialScreen4(){
	 ...
	 public static ScreenManager TutorialScreen4;
     ...
     public static void run() {
     	TutorialScreen4 = new ScreenManager();;
         try {
             DisplayMode displayMode =
             TutorialScreen4.findFirstCompatibleMode(POSSIBLE_MODES);
             TutorialScreen4.setFullScreen(displayMode);
             TutorialScreen4.getFullScreenWindow();
             Window windowStart = TutorialScreen4.getFullScreenWindow();
             windowStart.addKeyListener(new KeyClass());
             loadImages();
             animationLoop();
         }
         finally {
        	 TutorialScreen4.restoreScreen();
         }
     }
     
	public static void loadImages() {
        //loads images into buffer
         bgImage = loadImage("images/4health4.jpg");
    ...
    public static void animationLoop() 
    {
    	while(setState == 0)
    	{
    		...
    		Graphics2D g = TutorialScreen4.getGraphics();
    		draw(g);
    		g.dispose();
    ...
    /*	else if(setState== 3){
    		TutorialScreen5 ts5 = new TutorialScreen5();
    		TutorialScreen4.restoreScreen();                      // This will make the tutorial loop back to the previous screen. Currently flickers and does not stop.
    		ts5.run(); 
    	} */
    }
